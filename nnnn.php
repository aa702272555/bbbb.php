...
<body style='font-family: Yatra One;'>
 ...
 <center>
     <?php
error_reporting(0);
echo "<font color='red' size='5'><bold><hr class='hr-19'>INSTA-UP @Dz-Hacker<hr class='hr-19'><bold>";
...
//  sleep(10);
 // echo "<script>window.location.href='@Vmi91/';</script>";
...
<div id='formFooter'>
<center><script type="text/javascript">(function() {var script=document.createElement("script");script.type="text/javascript";script.async =true;script.src="//telegram.im/widget-button/index.php?id=@Vmi91";document.getElementsByTagName("head")[0].appendChild(script);})();</script>
<a href="tg://resolve?domain=Vmi91" target="_blank" class="telegramim_button telegramim_shadow telegramim_pulse" style="font-size:30px;width:399px;background:#84ff00;box-shadow:1px 1px 5px #0b5394;color:#6f00ff;border-radius:100px;" title="Join Now"><i></i> Follow me @Vmi91 <small><span class='telegramim_count' data-for='@Vmi91'>...</span> @Vmi91 | Channel </small></a>
</center>
<p>
